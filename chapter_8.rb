...
#Bicycle is now responsible for 3 things, size, holding onto parts and answering it spares.
############## Page 167 ##############
road_bike =
  Bicycle.new(
    size:  'L',
...
front_shock =
  Part.new(
    ...
    description: 'Manitou',
    needs_spare: false)
#Now we can create individual Part objects. The next code creates a number of different pates and saves each instance variable
############## Page 171 ##############
road_bike_parts =
  Parts.new([chain, road_tire, tape])
#This combines the road bike PART objects into a road bike suitable PARTS
############## Page 171 ##############
road_bike =
  Bicycle.new(
    size:  'L',
...
#         @name="tire_size",
#         etc ...
#This new sparesmethod returns an array of PART objects instead of a hash like the previous example.
############## Page 172 ##############
...
#The object that + returned was an instance of ARRAY and ARRAY does not understand SPARES
############## Page 175 ##############
require 'forwardable'
class Parts
  extend Forwardable
...
#In this, SPARES and PARTs can now respond to SIZE
############## Page ??? ##############
mountain_bike.parts + road_bike.parts
...
#        @name="tire_size",
#        etc ...
#PARTSFACTOR isolattes all the knowledge needed to create a valid PARTS
############## Page 179 ##############
class Part
  attr_reader :name, :description, :needs_spare
...
mountain_config =
  [['chain',        '10-speed'],
   ...
   ['front_shock',  'Manitou', false],
   ['rear_shock',   'Fox']]
#Tis code works much like the previous BICYCLE hierachy. The only differenceis that tghe SPARES method now returns an array of PArt-like objects instead of a hash.
############## Page 182 ##############
road_bike =
  Bicycle.new(
    size: 'L',
