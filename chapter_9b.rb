...
#In this, GEAR no longer cares about the  class of the injected object, it merely expects that it implement diameter
############## Page 206 ##############
...
#GEAR still sends DIAMETER in its GEAR_INCHES methods
############## Page ?? ##############
