...
#Reminder of the original MECHANIC, TRIP COORDINATOR and DRIVER classes
############## Page 220 ##############
...
#Now that PREPARERS exist, TRIP's PREPARE method can be vastle simplified :)
############## Page 221 ##############
class Trip
  attr_reader :bicycles, :customers, :vehicle
...
#test_requests_trip_preparation test lives directly in TRIPTEST